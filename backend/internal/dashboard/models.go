...
type LatestInvoice struct {
	...
	FinalAmount billing.Money `json:"final_amount"`
...
type HomeSummary struct {
	PayableAmount           billing.Money        `json:"payable_amount"`
...
type DashboardAlert struct {
	...
	UnitNumber string        `json:"unit_number,omitempty"`
	Amount     billing.Money `json:"amount,omitempty"`
...
type BuildingDashboard struct {
	...
	TotalDebt         billing.Money        `json:"total_debt"`
	MonthIncome       billing.Money        `json:"month_income"`
	MonthExpense      billing.Money        `json:"month_expense"`
